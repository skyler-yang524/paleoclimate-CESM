...
### Porting of CESM1
CESM1 installation package could be found in the NCAR CESM1 user guide: [here](https://www2.cesm.ucar.edu/models/cesm1.2/cesm/doc/usersguide/ug.pdf). Follow the user guide instruction, download the newest version (I used CESM1.2.2). However, there are some libaries used in CESM1 are already outdated. Please check my `Issue' section for updated libararies for CESM1 downloading. 
### Config Files
Similarly, the initial configuration files for Niagara can be found on John's GitHub page. However, since CESM1 is quite an old version, there are some issues with the config files. I will also post my configuration files later if everything goes well!
